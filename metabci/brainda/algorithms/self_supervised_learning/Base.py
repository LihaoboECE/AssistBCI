...
#         self.model = BackBone(input_size=size, input_channel=1, layers=[1, 1, 1, 1])
...
#         # )
#
#         # self.feature = self.model.get_final_length() // 2
#         # self.feature_layer = nn.Sequential(
#         #     nn.Linear(self.model.get_final_length(), self.feature),
#         #     nn.ELU(),
#         #     nn.Linear(self.feature, size)
#         # )
#         self.feature_layer = nn.Sequential(
...
#         self.conv1 = nn.Conv1d(input_channel, 32, kernel_size=5, stride=1, padding=3, bias=False)
...
#         self.maxpool3 = nn.AvgPool1d(kernel_size=10, stride=1, padding=0)
#
...
#         self.maxpool7 = nn.AvgPool1d(kernel_size=10, stride=1, padding=0)
#
#     def forward(self, x0):
#         b = x0.shape[0]
#         x0 = self.conv1(x0)
